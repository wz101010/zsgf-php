...
```php
wechatGenerateScheme($app_key, $body): \ZSGF\Client\ZSGF\Client\Model\StringApiResponse
```
...
$app_key = 'app_key_example'; // string
$body = NULL; // mixed | scheme码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/qrcode-link/url-scheme/generateScheme.html
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **body** | **mixed**| scheme码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/qrcode-link/url-scheme/generateScheme.html | [optional] |
...
```php
wechatSubscribeMSG($app_key, $body): \ZSGF\Client\ZSGF\Client\Model\StringApiResponse
```
...
$app_key = 'app_key_example'; // string
$body = NULL; // mixed | 订阅消息数据，开发参考：https://dwz.cn/IXptek5n
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **body** | **mixed**| 订阅消息数据，开发参考：https://dwz.cn/IXptek5n | [optional] |
...
```php
wechatSubscribeSend($app_key, $body): \ZSGF\Client\ZSGF\Client\Model\StringApiResponse
```
...
$app_key = 'app_key_example'; // string
$body = NULL; // mixed | 订阅消息数据，开发参考：https://dwz.cn/bohXaCnp
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **body** | **mixed**| 订阅消息数据，开发参考：https://dwz.cn/bohXaCnp | [optional] |
...
```php
wechatUrlLinkGenerate($app_key, $body): \ZSGF\Client\ZSGF\Client\Model\StringApiResponse
```
...
$app_key = 'app_key_example'; // string
$body = NULL; // mixed | 跳转地址数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/url-link/urllink.generate.html
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **body** | **mixed**| 跳转地址数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/url-link/urllink.generate.html | [optional] |
...
```php
wechatWXACodeGet($app_key, $body): \SplFileObject
```
...
$app_key = 'app_key_example'; // string
$body = NULL; // mixed | 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.get.html
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **body** | **mixed**| 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.get.html | [optional] |
...
```php
wechatWXACodeGetUnlimited($app_key, $body): \SplFileObject
```
...
$app_key = 'app_key_example'; // string
$body = NULL; // mixed | 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.getUnlimited.html
...
| ------------- | ------------- | ------------- | ------------- |
| **app_key** | **string**|  | |
| **body** | **mixed**| 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.getUnlimited.html | [optional] |
