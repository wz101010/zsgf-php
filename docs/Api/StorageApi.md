...
```php
storageAggregate($table, $app_key, $pipeline): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageClear($table, $app_key, $filter): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageDelete($table, $id, $app_key): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageDeleteIndex($table, $app_key, $index_name): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageDetail($table, $id, $app_key, $project): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageExecuteFunction($nonce, $timestamp, $signature, $app_key, $execute_function_request): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
$app_key = 'app_key_example'; // string
$execute_function_request = new \ZSGF\Client\ZSGF\Client\Model\ExecuteFunctionRequest(); // \ZSGF\Client\ZSGF\Client\Model\ExecuteFunctionRequest | 
...
| **signature** | **string**|  | |
| **app_key** | **string**|  | |
| **execute_function_request** | [**\ZSGF\Client\ZSGF\Client\Model\ExecuteFunctionRequest**](../Model/ExecuteFunctionRequest.md)|  | [optional] |
...
```php
storageImport($table, $app_key, $file): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageIndexes($table, $app_key): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageList($table, $app_key, $filter, $project, $sort, $start_time, $end_time, $explain, $take, $skip): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storagePost($table, $app_key, $request_body): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storagePostIndex($table, $app_key, $post_index_request): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storagePut($table, $id, $app_key, $body, $replace): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageRemove($table, $app_key): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageStats($table, $app_key): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
storageTables($app_key): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
