...
```php
accessTokenDelete($id, $app_key): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
accessTokenPost($app_key, $access_token_post_request): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
accessTokenPut($id, $app_key, $access_token_put_request): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
...
```php
accessTokens($app_key, $user_id, $skip, $take): \ZSGF\Client\ZSGF\Client\Model\JObjectApiResult
```
