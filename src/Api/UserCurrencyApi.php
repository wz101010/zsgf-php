...
class UserCurrencyApi
{
     ...
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\CurrencyConsumeRequest|null $currency_consume_request  (optional)
     ...
     * @param  string $signature 签名 (required)
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\ExchangeCurrencyRequest|null $exchange_currency_request  (optional)
     ...
     * @param  string $signature 签名 (required)
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\RechargePointRequest|null $recharge_point_request  (optional)
