...
class WechatApi
{
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  mixed|null $body scheme码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/OpenApiDoc/qrcode-link/url-scheme/generateScheme.html (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  mixed|null $body 订阅消息数据，开发参考：https://dwz.cn/IXptek5n (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  mixed|null $body 订阅消息数据，开发参考：https://dwz.cn/bohXaCnp (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  mixed|null $body 跳转地址数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/url-link/urllink.generate.html (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  mixed|null $body 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.get.html (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  mixed|null $body 小程序码数据，开发参考：https://developers.weixin.qq.com/miniprogram/dev/api-backend/open-api/qr-code/wxacode.getUnlimited.html (optional)
