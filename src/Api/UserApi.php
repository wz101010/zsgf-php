...
class UserApi
{
     ...
     * @return \ZSGF\Client\ZSGF\Client\Model\UserApiResponse
     */
     ...
     * @throws \ZSGF\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ZSGF\Client\ZSGF\Client\Model\UserApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function userWithHttpInfo($id, $app_key, string $contentType = self::contentTypes['user'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZSGF\Client\ZSGF\Client\Model\UserApiResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ZSGF\Client\ZSGF\Client\Model\UserApiResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZSGF\Client\ZSGF\Client\Model\UserApiResponse', []),
            ...
            $returnType = '\ZSGF\Client\ZSGF\Client\Model\UserApiResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZSGF\Client\ZSGF\Client\Model\UserApiResponse',
     ...
     * @throws \ZSGF\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse
     */
     ...
     * @throws \ZSGF\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function userFollowingWithHttpInfo($app_key, $tag = null, $status = null, $skip = 0, $take = 10, string $contentType = self::contentTypes['userFollowing'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZSGF\Client\ZSGF\Client\Model\UserFollowingResultApiResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int|null $age_s 年龄段起始 (optional)
     * @param  int|null $age_e 年龄段结束 (optional)
     * @param  string|null $tag 兴趣标签 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  bool|null $check 是否进行检查 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\OAuthAccountBindRequest|null $o_auth_account_bind_request 绑定请求参数 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\OAuthAccountSignInRequest|null $o_auth_account_sign_in_request 登录请求参数 (optional)
     ...
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\OAuthAccountPutBindRequest|null $o_auth_account_put_bind_request 更新请求参数 (optional)
     ...
     * @param  int $id 用户ID (required)
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\User|null $user 用户信息 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\QRCodePreSignInRequest|null $qr_code_pre_sign_in_request 预登陆请求参数 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\QRCodeScanRequest|null $qr_code_scan_request 扫码请求参数 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\QRCodeSignInRequest|null $qr_code_sign_in_request 登录请求参数 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\QRCodeSignUpRequest|null $qr_code_sign_up_request 注册请求参数 (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  string|null $user_name 用户名 (optional)
     * @param  string|null $email 邮箱 (optional)
     * @param  string|null $phone 电话 (optional)
     * @param  string|null $platform 平台 (optional)
     * @param  string|null $union_id 联合ID (optional)
     * @param  string|null $role 角色 (optional)
     * @param  int|null $skip 跳过的记录数 (optional)
     ...
     * @throws \ZSGF\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse
     */
     ...
     * @throws \ZSGF\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function usersWithHttpInfo($app_key, $user_name = null, $email = null, $phone = null, $platform = null, $union_id = null, $role = null, $skip = null, $take = null, string $contentType = self::contentTypes['users'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ZSGF\Client\ZSGF\Client\Model\UserListResultApiResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
