...
class AppSettingApi
{
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\ServiceGroup|null $service_group  (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\ServiceItem|null $service_item  (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\ServiceProvider|null $service_provider  (optional)
     ...
     *
     * @param  string $app_key app_key (required)
     * @param  \ZSGF\Client\ZSGF\Client\Model\AppSetting|null $app_setting  (optional)
