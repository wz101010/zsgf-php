    ...
    */
    ...
    public function setLocationName($location_name)
    {
        ...
        if (!is_null($location_name) && (mb_strlen($location_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $location_name when calling GeoLocationModel., must be smaller than or equal to 50.');
        }
    ...
    public function setLocationType($location_type)
    {
        ...
        if ((mb_strlen($location_type) > 20)) {
            throw new \InvalidArgumentException('invalid length for $location_type when calling GeoLocationModel., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($location_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $location_type when calling GeoLocationModel., must be bigger than or equal to 1.');
        }
    ...
    public function setRecipientName($recipient_name)
    {
        ...
        if (!is_null($recipient_name) && (mb_strlen($recipient_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $recipient_name when calling GeoLocationModel., must be smaller than or equal to 50.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 20)) {
            throw new \InvalidArgumentException('invalid length for $country when calling GeoLocationModel., must be smaller than or equal to 20.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 20)) {
            throw new \InvalidArgumentException('invalid length for $state when calling GeoLocationModel., must be smaller than or equal to 20.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 20)) {
            throw new \InvalidArgumentException('invalid length for $city when calling GeoLocationModel., must be smaller than or equal to 20.');
        }
    ...
    public function setDistrict($district)
    {
        ...
        if (!is_null($district) && (mb_strlen($district) > 50)) {
            throw new \InvalidArgumentException('invalid length for $district when calling GeoLocationModel., must be smaller than or equal to 50.');
        }
    ...
    public function setStreet($street)
    {
        ...
        if (!is_null($street) && (mb_strlen($street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street when calling GeoLocationModel., must be smaller than or equal to 255.');
        }
    ...
    public function setZipCode($zip_code)
    {
        ...
        if (!is_null($zip_code) && (mb_strlen($zip_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling GeoLocationModel., must be smaller than or equal to 20.');
        }
    ...
    public function setAddress($address)
    {
        ...
        if (!is_null($address) && (mb_strlen($address) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $address when calling GeoLocationModel., must be smaller than or equal to 1000.');
        }
    ...
    public function setMapType($map_type)
    {
        ...
        if (!is_null($map_type) && (mb_strlen($map_type) > 20)) {
            throw new \InvalidArgumentException('invalid length for $map_type when calling GeoLocationModel., must be smaller than or equal to 20.');
        }
    ...
    public function setRemark($remark)
    {
        ...
        if (!is_null($remark) && (mb_strlen($remark) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $remark when calling GeoLocationModel., must be smaller than or equal to 5000.');
        }
    ...
    public function setTags($tags)
    {
        ...
        if (!is_null($tags) && (mb_strlen($tags) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling GeoLocationModel., must be smaller than or equal to 1000.');
        }
