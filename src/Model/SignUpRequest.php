    ...
    */
    ...
    public function setUserName($user_name)
    {
        ...
        if ((mb_strlen($user_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling SignUpRequest., must be smaller than or equal to 32.');
        }
        if ((mb_strlen($user_name) < 6)) {
            throw new \InvalidArgumentException('invalid length for $user_name when calling SignUpRequest., must be bigger than or equal to 6.');
        }
     ...
     * Sets pwd
     *
     * @param string $pwd 登录密码，长度必须在6到32个字符之间，只能包含字母和数字
     *
     * @return self
     */
    public function setPwd($pwd)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9_\\-!@#$%^&*()]*$/", ObjectSerializer::toString($pwd)))) {
            throw new \InvalidArgumentException("invalid value for \$pwd when calling SignUpRequest., must conform to the pattern /^[a-zA-Z0-9_\\-!@#$%^&*()]*$/.");
        }
     ...
     * Sets nick_name
     *
     * @param string|null $nick_name 用户昵称，长度不能超过20个字符
     *
     * @return self
     */
    public function setNickName($nick_name)
    {
        ...
        if (!is_null($nick_name) && (mb_strlen($nick_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling SignUpRequest., must be smaller than or equal to 32.');
        }
        if (!is_null($nick_name) && (mb_strlen($nick_name) < 4)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling SignUpRequest., must be bigger than or equal to 4.');
        }
