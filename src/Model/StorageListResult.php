...
/**
 * StorageListResult Class Doc Comment
 *
 * @category Class
 * @package  ZSGF\Client
 * @author   OpenAPI Generator team
 ...
 */
class StorageListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StorageListResult';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('explain', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets explain
     *
     * @param mixed|null $explain explain
     *
     * @return self
     */
    ...
    {
        if (is_null($explain)) {
            array_push($this->openAPINullablesSetToNull, 'explain');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('explain', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
