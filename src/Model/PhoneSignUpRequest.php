...
class PhoneSignUpRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets phone_code
     *
     * @param string $phone_code 手机验证码，长度为4到8位的数字
     *
     * @return self
     */
     ...
     * Sets pwd
     *
     * @param string $pwd 用户密码，长度为6到32个字符
     *
     * @return self
     */
    public function setPwd($pwd)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9_\\-!@#$%^&*()]*$/", ObjectSerializer::toString($pwd)))) {
            throw new \InvalidArgumentException("invalid value for \$pwd when calling PhoneSignUpRequest., must conform to the pattern /^[a-zA-Z0-9_\\-!@#$%^&*()]*$/.");
        }
    ...
    public function setNickName($nick_name)
    {
        ...
        if (!is_null($nick_name) && (mb_strlen($nick_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling PhoneSignUpRequest., must be smaller than or equal to 32.');
        }
        if (!is_null($nick_name) && (mb_strlen($nick_name) < 4)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling PhoneSignUpRequest., must be bigger than or equal to 4.');
        }
