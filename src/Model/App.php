...
class App implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets project_id
     *
     * @param int|null $project_id 项目 ID
     *
     * @return self
     */
     ...
     * Sets website
     *
     * @param string|null $website 网站默认域名
     *
     * @return self
     */
     ...
     * Sets app_key
     *
     * @param string|null $app_key 应用公钥
     *
     * @return self
     */
     ...
     * Sets app_secret
     *
     * @param string|null $app_secret 应用私密密钥
     *
     * @return self
     */
     ...
     * Sets client_secret
     *
     * @param string|null $client_secret 客户端密钥
     *
     * @return self
     */
     ...
     * Sets ssh_publickey
     *
     * @param string|null $ssh_publickey SSH公钥
     *
     * @return self
     */
