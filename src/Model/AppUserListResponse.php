...
class AppUserListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets union_id
     *
     * @param string|null $union_id 用户的联合ID
     *
     * @return self
     */
     ...
     * Sets create_date
     *
     * @param \DateTime|null $create_date 用户创建日期
     *
     * @return self
     */
     ...
     * Sets last_update
     *
     * @param \DateTime|null $last_update 用户最后更新日期
     *
     * @return self
     */
