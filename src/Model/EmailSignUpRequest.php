    ...
    */
    ...
    public function setPwd($pwd)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9_\\-!@#$%^&*()]*$/", ObjectSerializer::toString($pwd)))) {
            throw new \InvalidArgumentException("invalid value for \$pwd when calling EmailSignUpRequest., must conform to the pattern /^[a-zA-Z0-9_\\-!@#$%^&*()]*$/.");
        }
     ...
     * Sets phone
     *
     * @param string|null $phone 手机号，必须为11位数字
     *
     * @return self
     */
    ...
    public function setNickName($nick_name)
    {
        ...
        if (!is_null($nick_name) && (mb_strlen($nick_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling EmailSignUpRequest., must be smaller than or equal to 32.');
        }
        if (!is_null($nick_name) && (mb_strlen($nick_name) < 4)) {
            throw new \InvalidArgumentException('invalid length for $nick_name when calling EmailSignUpRequest., must be bigger than or equal to 4.');
        }
