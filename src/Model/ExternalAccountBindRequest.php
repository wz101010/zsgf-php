...
/**
 * ExternalAccountBindRequest Class Doc Comment
 *
 * @category Class
 * @package  ZSGF\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExternalAccountBindRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExternalAccountBindRequest';
    ...
    */
    ...
    public function setUnionId($union_id)
    {
        ...
        if ((mb_strlen($union_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $union_id when calling ExternalAccountBindRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatform($platform)
    {
        ...
        if ((mb_strlen($platform) < 1)) {
            throw new \InvalidArgumentException('invalid length for $platform when calling ExternalAccountBindRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPlatformName($platform_name)
    {
        ...
        if ((mb_strlen($platform_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $platform_name when calling ExternalAccountBindRequest., must be bigger than or equal to 1.');
        }
