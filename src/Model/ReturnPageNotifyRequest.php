...
class ReturnPageNotifyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets auth_app_id
     *
     * @param string|null $auth_app_id 授权应用ID
     *
     * @return self
     */
     ...
     * Sets seller_id
     *
     * @param string|null $seller_id 卖家支付宝用户号
     *
     * @return self
     */
     ...
     * Sets sign_type
     *
     * @param string|null $sign_type 签名类型
     *
     * @return self
     */
     ...
     * Sets total_amount
     *
     * @param string|null $total_amount 订单总金额
     *
     * @return self
     */
     ...
     * Sets version
     *
     * @param string|null $version 接口版本
     *
     * @return self
     */
