 ...
 *
 * @category Class
 * @description 服务商实体，用于表示和管理系统中的服务提供方信息。
 * @package  ZSGF\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ServiceProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets biz_code
     *
     * @param string|null $biz_code 服务商的业务代码，用于标识其所属业务领域。
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code 服务商的唯一代码，用于系统内部标识。
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon 服务商图标的URL或路径。
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description 服务商的详细描述信息。
     *
     * @return self
     */
     ...
     * Sets tags
     *
     * @param string|null $tags 用于分类或标记服务商的标签。
     *
     * @return self
     */
     ...
     * Sets show
     *
     * @param bool|null $show 指示服务商是否在界面上显示。
     *
     * @return self
     */
     ...
     * Sets show_index
     *
     * @param int|null $show_index 服务商在界面上的显示顺序。
     *
     * @return self
     */
     ...
     * Sets create_date
     *
     * @param \DateTime|null $create_date 服务商记录的创建日期，默认为当前时间。
     *
     * @return self
     */
     ...
     * Sets last_update
     *
     * @param \DateTime|null $last_update 服务商记录的最后更新日期，默认为当前时间。
     *
     * @return self
     */
