 ...
 *
 * @category Class
 * @description 服务功能分组实体，用于对服务功能进行分类和管理。
 * @package  ZSGF\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class ServiceGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id 服务功能分组的唯一标识符。
     *
     * @return self
     */
     ...
     * Sets provider_id
     *
     * @param int|null $provider_id 关联的服务商的唯一标识符。
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name 服务功能分组的名称。
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code 服务功能分组的唯一代码，用于系统内部标识。
     *
     * @return self
     */
     ...
     * Sets icon
     *
     * @param string|null $icon 服务功能分组的图标URL或路径。
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description 服务功能分组的详细描述信息。
     *
     * @return self
     */
     ...
     * Sets show
     *
     * @param bool|null $show 指示服务功能分组是否在界面上显示。
     *
     * @return self
     */
     ...
     * Sets show_index
     *
     * @param int|null $show_index 服务功能分组在界面上的显示顺序。
     *
     * @return self
     */
     ...
     * Sets create_date
     *
     * @param \DateTime|null $create_date 服务功能分组的创建日期，默认为当前时间。
     *
     * @return self
     */
     ...
     * Sets last_update
     *
     * @param \DateTime|null $last_update 服务功能分组的最后更新日期，默认为当前时间。
     *
     * @return self
     */
